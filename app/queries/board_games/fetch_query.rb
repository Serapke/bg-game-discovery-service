module BoardGames
  class FetchQuery
    ...
    def call(ids: nil, player_count: nil, max_playing_time: nil, game_types: nil, game_categories: nil, min_rating: nil)
      scope = if ids
        fetch_by_ids(ids)
      else
        fetch_all
      ...
      apply_filters(scope, player_count: player_count, max_playing_time: max_playing_time, game_types: game_types, game_categories: game_categories, min_rating: min_rating)
    end

    def paginated(sort:, page:, per_page:, player_count: nil, max_playing_time: nil, game_types: nil, game_categories: nil, min_rating: nil)
      ...
      filtered = apply_filters(base, player_count: player_count, max_playing_time: max_playing_time, game_types: game_types, game_categories: game_categories, min_rating: min_rating)
    ...
    def apply_filters(scope, player_count:, max_playing_time:, game_types:, game_categories:, min_rating:)
      ...
      scope = scope.with_game_categories(game_categories) if game_categories.present?
